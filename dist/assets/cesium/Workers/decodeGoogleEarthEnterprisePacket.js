...
!(function() {
    define("Core/defined", [], function() {
        ...
        define("Core/decodeGoogleEarthEnterpriseData", ["./Check", "./RuntimeError"], function(
            e,
            t
        ) {
            "use strict";
            function n(e, o) {
                if (n.passThroughDataForTesting) return o;
                var a = e.byteLength;
                if (0 === a || a % 4 != 0)
                    throw new t("The length of key must be greater than 0 and a multiple of 4.");
                var s = new DataView(o),
                    f = s.getUint32(0, !0);
                if (f === r || f === i) return o;
                for (
                    var u,
                    ...
                    for (b = (b + 8) % 24, u = b; l < d && u < w; )
                        s.setUint32(l, s.getUint32(l, !0) ^ c.getUint32(u, !0), !0),
                            s.setUint32(l + 4, s.getUint32(l + 4, !0) ^ c.getUint32(u + 4, !0), !0),
                            (l += 8),
                            (u += 24);
                if (l < h)
                    for (u >= w && ((b = (b + 8) % 24), (u = b)); l < h; )
        ...
        define("Core/GoogleEarthEnterpriseTileInformation", ["./defined", "./isBitSet"], function(
            e,
            t
        ) {
            "use strict";
            function n(e, t, n, r, i, o) {
                (this._bits = e),
                    ...
                    (this.terrainProvider = o),
                    (this.ancestorHasTerrain = !1),
                    (this.terrainState = void 0);
            }
            var r = [1, 2, 4, 8];
            return (
                (n.clone = function(t, r) {
                    return (
                        e(r)
                            ? ((r._bits = t._bits),
                              (r.cnodeVersion = t.cnodeVersion),
                              (r.imageryVersion = t.imageryVersion),
                              (r.terrainVersion = t.terrainVersion),
                              (r.imageryProvider = t.imageryProvider),
                              (r.terrainProvider = t.terrainProvider))
                            : (r = new n(
                                  t._bits,
                                  t.cnodeVersion,
                                  t.imageryVersion,
                        ...
                        (r.ancestorHasTerrain = t.ancestorHasTerrain),
                        (r.terrainState = t.terrainState),
                        r
                    );
                }),
                ...
                (n.prototype.hasChild = function(e) {
                    return t(this._bits, r[e]);
                }),
            ...
            })(
                {
                                    ...
                                    for (o = 0; o < s; o++)
                                        (n = e.charCodeAt(o)),
                                            55296 == (64512 & n) &&
                                                ...
                                                o++),
                                            (f += n < 128 ? 1 : n < 2048 ? 2 : n < 65536 ? 3 : 4);
                                    for (t = new i.Buf8(f), a = 0, o = 0; a < f; o++)
                                        (n = e.charCodeAt(o)),
                                            55296 == (64512 & n) &&
                                                o + 1 < s &&
                                                56320 == (64512 & (r = e.charCodeAt(o + 1))) &&
                        ...
                        function(e, t, n) {
                            ...
                            function o(e) {
                                ...
                                return e && e.state
                                    ? ((t = e.state),
                                      ...
                                      (t.hold = 0),
                                      (t.bits = 0),
                                      (t.lencode = t.lendyn = new p.Buf32(be)),
                            ...
                            function c(e) {
                                if (pe) {
                                    var t;
                                    for (
                                        m = new p.Buf32(512), g = new p.Buf32(32), t = 0;
                                        t < 144;
                                    ...
                                    for (
                                        _(x, e.lens, 0, 288, m, 0, e.work, { bits: 9 }), t = 0;
                                        t < 32;

                                    )
                                        e.lens[t++] = 5;
                                    _(T, e.lens, 0, 32, g, 0, e.work, { bits: 5 }), (pe = !1);
                                }
                                (e.lencode = m),
                                    (e.lenbits = 9),
                                    (e.distcode = g),
                            ...
                            function l(e, t, n, r) {
                                ...
                                return (
                                    null === o.window &&
                                        ...
                                        (o.wnext = 0),
                                        (o.whave = 0),
                                        (o.window = new p.Buf8(o.wsize))),
                                    r >= o.wsize
                                        ? (p.arraySet(o.window, t, n - o.wsize, o.wsize, 0),
                                          (o.wnext = 0),
                                          (o.whave = o.wsize))
                                        : ((i = o.wsize - o.wnext),
                                          i > r && (i = r),
                                          p.arraySet(o.window, t, n - r, i, o.wnext),
                                          (r -= i),
                                          r
                                              ? (p.arraySet(o.window, t, n - r, r, 0),
                                                (o.wnext = r),
                                                (o.whave = o.wsize))
                                              : ((o.wnext += i),
                                ...
                                e: for (;;)
                                    switch (n.mode) {
                                            ...
                                            if (
                                                ...
                                                m &&
                                                    (n.head &&
                                                        ...
                                                        p.arraySet(n.head.extra, i, a, m, _e)),
                                                    512 & n.flags &&
                                                        (n.check = k(n.check, i, m, a)),
                                                    (f -= m),
                                                    (a += m),
                                                    (n.length -= m)),
                                                n.length)
                                                ...
                                                do {
                                                    (_e = i[a + m++]),
                                                        n.head &&
                                                            _e &&
                                                            n.length < 65536 &&
                                                            (n.head.name += String.fromCharCode(
                                                                _e
                                                            ));
                                                } while (_e && m < f);
                                                if (
                                                ...
                                                do {
                                                    (_e = i[a + m++]),
                                                        n.head &&
                                                            _e &&
                                                            n.length < 65536 &&
                                                            (n.head.comment += String.fromCharCode(
                                                                _e
                                                            ));
                                                } while (_e && m < f);
                                                if (
                                        ...
                                        case oe:
                                            for (
                                                ;
                                                (Se = n.distcode[h & ((1 << n.distbits) - 1)]),
                                                    (me = Se >>> 24),
                                                    (ge = (Se >>> 16) & 255),
                                                    (pe = 65535 & Se),
                                                    !(me <= d);
                                            ...
                                            if (((h >>>= me), (d -= me), (n.back += me), 64 & ge)) {
                                                (e.msg = "invalid distance code"), (n.mode = he);
                                                break;
                                            }
                                            (n.offset = pe), (n.extra = 15 & ge), (n.mode = ae);
                                        case ae:
                                            if (n.extra) {
                                                for (Te = n.extra; d < Te; ) {
                                                    if (0 === f) break e;
                                        ...
                                        case se:
                                            ...
                                            if (((m = b - u), n.offset > m)) {
                                                ...
                                                m > n.wnext
                                                    ? ((m -= n.wnext), (g = n.wsize - m))
                                                    : (g = n.wnext - m),
                                                    m > n.length && (m = n.length),
                                                    (be = n.window);
                                            } else (be = o), (g = s - n.offset), (m = n.length);
                                    ...
                                    l(e, e.output, e.next_out, b - e.avail_out)
                                        ...
                                        : ((w -= e.avail_in),
                                          ...
                                          n.wrap &&
                                              b &&
                                              (e.adler = n.check = n.flags
                                                  ? k(n.check, o, b, e.next_out - b)
                                                  : v(n.check, o, b, e.next_out - b)),
                                          (e.data_type =
                                              n.bits +
                                              (n.last ? 64 : 0) +
                                              (n.mode === G ? 128 : 0) +
                                              (n.mode === ne || n.mode === Q ? 256 : 0)),
                                          ((0 === w && 0 === b) || t === S) && Ee === A && (Ee = D),
                                          Ee)
                                );
                            }
                            function d(e) {
                            ...
                            function w(e, t) {
                                ...
                                return e && e.state
                                    ? ((n = e.state),
                                      0 == (2 & n.wrap) ? U : ((n.head = t), (t.done = !1), A))
                                    : U;
                            }
                            function b(e, t) {
                                var n,
                    ...
                    9: [
                        function(e, t, n) {
                            ...
                            t.exports = function(e, t, n, f, u, c, l, h) {
                                var d,
                                    w,
                                    b,
                                    m,
                                ...
                                for (x = 0; x < f; x++) D[t[n + x]]++;
                                for (O = _, S = 15; S >= 1 && 0 === D[S]; S--);
                                if ((O > S && (O = S), 0 === S))
                                    return (
                                        (u[c++] = 20971520), (u[c++] = 20971520), (h.bits = 1), 0
                                    );
                                for (T = 1; T < S && 0 === D[T]; T++);
                                for (O < T && (O = T), C = 1, E = 1; E <= 15; E++)
                                    if (((C <<= 1), (C -= D[E]) < 0)) return -1;
                                if (C > 0 && (0 === e || 1 !== S)) return -1;
                                for (N[1] = 0, E = 1; E < 15; E++) N[E + 1] = N[E] + D[E];
                                for (x = 0; x < f; x++) 0 !== t[n + x] && (l[N[t[n + x]]++] = x);
                                if (
                                    (0 === e
                                        ? ((I = z = l), (p = 19))
                                        : 1 === e
                                        ? ((I = i), (Z -= 257), (z = o), (j -= 257), (p = 256))
                                        : ((I = a), (z = s), (p = -1)),
                                    (U = 0),
                                    (x = 0),
                                    (E = T),
                                ...
                                for (;;) {
                                    ...
                                    if (E > O && (U & m) !== b) {
                                        ...
                                        if (
                                            ...
                                            return 1;
                                        (b = U & m), (u[b] = (O << 24) | (B << 16) | (g - c) | 0);
                                    }
                                }
                                return (
                                    0 !== U && (u[g + U] = ((E - A) << 24) | (64 << 16) | 0),
                                    (h.bits = O),
                                    0
                                );
                            };
                        ...
                        function(e, t, n) {
                            ...
                            (r.prototype.push = function(e, t) {
                                ...
                                do {
                                    if (
                                        (0 === h.avail_out &&
                                            ((h.output = new s.Buf8(w)),
                                            (h.next_out = 0),
                                            (h.avail_out = w)),
                                        (n = a.inflate(h, u.Z_NO_FLUSH)),
                                        n === u.Z_NEED_DICT &&
                                            b &&
                                            ((l =
                                                "string" == typeof b
                                                    ? f.string2buf(b)
                                                    : "[object ArrayBuffer]" === d.call(b)
                                                    ? new Uint8Array(b)
                                                    : b),
                                            (n = a.inflateSetDictionary(this.strm, l))),
                                        n === u.Z_BUF_ERROR && !0 === m && ((n = u.Z_OK), (m = !1)),
                                    ...
                                    h.next_out &&
                                        ((0 !== h.avail_out &&
                                            ...
                                            ("string" === this.options.to
                                                ? ((i = f.utf8border(h.output, h.next_out)),
                                                  (o = h.next_out - i),
                                                  (c = f.buf2string(h.output, i)),
                                                  (h.next_out = o),
                                                  (h.avail_out = w - o),
                                                  o && s.arraySet(h.output, h.output, i, o, 0),
                                                  this.onData(c))
        ...
        (function(e) {
            ...
            e("ThirdParty/when", [], function() {
                ...
                function a() {
                    ...
                    return (
                        ...
                        (f = {
                            ...
                            progress: s,
                            promise: u,
                            resolver: { resolve: n, reject: i, progress: s }
                        }),
                        (c = []),
                        (l = []),
                        (h = function(e, t, n) {
                        ...
                        (w = function(e) {
                            return (
                                (e = t(e)), (h = e.then), (w = t), (d = g), b(c, e), (l = c = y), e
                            );
                        }),
                        f
                    );
                ...
                function f(t, n, r, i, o) {
                    return (
                        ...
                        e(t, function(t) {
                            ...
                            var u, c, l, h, d, w, b, m, p, v;
                            if (
                                ((p = t.length >>> 0),
                                (u = Math.max(0, Math.min(n, p))),
                                (l = []),
                                (c = p - u + 1),
                                (h = []),
                                (d = a()),
                                ...
                                for (
                                    m = d.progress,
                                        b = function(e) {
                                            h.push(e), --c || ((w = b = g), d.reject(h));
                                        },
                                        w = function(e) {
                                            l.push(e), --u || ((w = b = g), d.resolve(l));
                                        },
                                        v = 0;
                                    v < p;
                                    ++v
                ...
                function c(e, t, n, r) {
                    return m(1, arguments), h(e, p).then(t, n, r);
                }
                function l() {
                    return h(arguments, p);
                }
                function h(t, n) {
                    return e(t, function(t) {
                        var r, i, o, s, f, u;
                        if (((o = i = t.length >>> 0), (r = []), (u = a()), o))
                            for (
                                s = function(t, i) {
        ...
        define("Workers/createTaskProcessorWorker", [
            ...
            function o(o) {
                ...
                return function(s) {
                    var f = s.data,
                        u = [],
                        c = { id: f.id, result: void 0, error: void 0 };
                    return e(i(o, f.parameters, u))
                        .then(function(e) {
                            c.result = e;
                        })
                        .otherwise(function(e) {
                            e instanceof Error
                                ? (c.error = { name: e.name, message: e.message, stack: e.stack })
                                : (c.error = e);
                        })
                        .always(function() {
                            n(a) || (a = t(self.webkitPostMessage, self.postMessage)),
                                f.canTransferArrayBuffer || (u.length = 0);
                            try {
                                a(c, u);
                            } catch (e) {
                                (c.result = void 0),
        ...
        define("Workers/decodeGoogleEarthEnterprisePacket", [
            ...
            function a(e, r, i) {
                ...
                var a = new DataView(e),
                    s = 0,
                    f = a.getUint32(s, !0);
                if (((s += l), f !== d)) throw new n("Invalid magic");
                var h = a.getUint32(s, !0);
                if (((s += l), 1 !== h))
                    throw new n("Invalid data type. Must be 1 for QuadTreePacket");
                var w = a.getUint32(s, !0);
                if (((s += l), 2 !== w))
                    throw new n("Invalid QuadTreePacket version. Only version 2 is supported.");
                var b = a.getInt32(s, !0);
                s += c;
                var m = a.getInt32(s, !0);
                if (((s += c), 32 !== m)) throw new n("Invalid instance size.");
                var g = a.getInt32(s, !0);
                s += c;
                var p = a.getInt32(s, !0);
                s += c;
                var v = a.getInt32(s, !0);
                if (((s += c), g !== b * m + s)) throw new n("Invalid dataBufferOffset");
                if (g + p + v !== r) throw new n("Invalid packet offsets");
                for (var k = [], y = 0; y < b; ++y) {
                    var _ = a.getUint8(s);
                    ++s, ++s;
                    var E = a.getUint16(s, !0);
                    s += u;
                    var x = a.getUint16(s, !0);
                    s += u;
                    var T = a.getUint16(s, !0);
                    (s += u), (s += u), (s += u), (s += c), (s += c), (s += 8);
                    var S = a.getUint8(s++),
                        O = a.getUint8(s++);
                    (s += u), k.push(new t(_, E, x, T, S, O));
                }
                var B = [],
                    A = 0,
                    C = 0,
                    R = k[A++];
                return "" === i ? ++C : (B[i] = R), o(i, R, C), B;
            }
            function s(e, t, n) {
                for (var r = new DataView(e), i = 0, o = []; i < t; ) {
                    for (var a = i, s = 0; s < 4; ++s) {
            ...
            function f(e) {
                var t = new DataView(e),
                    i = 0,
                    o = t.getUint32(i, !0);
                if (((i += l), o !== w && o !== b)) throw new n("Invalid magic");
                var a = t.getUint32(i, o === w);
                i += l;
                var s = new Uint8Array(e, i),
                    f = r.inflate(s);
                if (f.length !== a) throw new n("Size of packet doesn't match header");
                return f;
            }
            var u = Uint16Array.BYTES_PER_ELEMENT,
                c = Int32Array.BYTES_PER_ELEMENT,
                l = Uint32Array.BYTES_PER_ELEMENT,
                h = { METADATA: 0, TERRAIN: 1, DBROOT: 2 };
