...
$jscomp.polyfill = function(d, f, n, w) {
    if (f) {
        ...
        f != w &&
            null != f &&
            $jscomp.defineProperty(n, d, { configurable: !0, writable: !0, value: f });
    }
};
$jscomp.polyfill(
    "Math.imul",
    function(d) {
        return d
            ...
            : function(f, d) {
                  ...
                  return (
                      (n * g +
                          (((((f >>> 16) & 65535) * g + n * ((d >>> 16) & 65535)) << 16) >>> 0)) |
                      0
                  );
              };
    },
...
var DracoDecoderModule = function(d) {
    ...
    function n(e, b) {
        ...
        if (128 > c) {
            for (; 0 < b; )
                (c = String.fromCharCode.apply(String, T.subarray(e, e + Math.min(b, 1024)))),
                    (l = l ? l + c : c),
                    (e += 1024),
                    (b -= 1024);
            return l;
    ...
    function Na(e) {
        ...
        a.monitorRunDependencies && a.monitorRunDependencies(ha);
        0 == ha &&
            (null !== Ba && (clearInterval(Ba), (Ba = null)), sa && ((e = sa), (sa = null), e()));
    }
    function na() {
    ...
    (function() {
        ...
        function c(c, e, l) {
            ...
            if (a.instantiateWasm)
                try {
                    ...
                    return (
                        a.printErr("Module.instantiateWasm callback failed with error: " + kb), !1
                    );
                }
            a.wasmBinary ||
        ...
        "function" === typeof a.locateFile &&
            (a.locateFile("draco_decoder.wast"), (d = a.locateFile(d)), (f = a.locateFile(f)));
        var g = {
                global: null,
                env: null,
                asm2wasm: {
    ...
    a.asmLibraryArg = {
        ...
        ___syscall140: function(a, b) {
            ...
            try {
                ...
                return (
                    ("undefined" !== typeof FS && ia instanceof FS.ErrnoError) || W(ia), -ia.errno
                );
            }
        },
        ___syscall146: Q,
    ...
    if (V)
        if (
            ("function" === typeof a.locateFile
                ? (V = a.locateFile(V))
                : a.memoryInitializerPrefixURL && (V = a.memoryInitializerPrefixURL + V),
            pa || wa)
        ) {
